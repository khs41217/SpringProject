		...
		<footer class="jss1030">
            <div class="jss1031">
                <ul class="jss1032">
                    ...
                    <li>
                        <span class="jss195"><img src="resources/img/img/responsible.svg" alt="신선한 사료&amp;간식 유통기한 100% 책임제"></span>
                    </li>
                    <li>
                        <span class="jss195"><img src="resources/img/img/delivery.svg" alt="평일 오후 6시까지 주문 시 오늘발송"></span>
                    </li>
                    <li>
                        <span class="jss195"><img src="resources/img/img/free.svg" alt="3만원 이상 구매시 무료배송"></span>
                    </li>
                </ul>
            </div>
            <div class="jss1033">
            ...
            <ul class="a1052">
                ...
                <li>
                    <picture><source media="(max-width: 1199px)" srcset="resources/img/img/partner-4-logo.jpg"><source media="(min-width: 1200px)" srcset="resources/img/img/partner-4-logo.jpg"><img src="resources/img/img/partner-4-logo.jpg" alt="한국소비자 보호원" sizes="auto"></picture>
                </li>
                <li>
